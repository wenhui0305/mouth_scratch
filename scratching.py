...
excel_file = r'D:\码仓\香港泰康诺生物科技有限公司\mouth_scratch\label_grab_frames.xlsx'
sheet_name = 'Sheet1'
...
# 目标文件夹路径，将帧图像复制到这里
output_folder = r'D:\码仓\香港泰康诺生物科技有限公司\mouth_scratch\frames_scratch'
...
for index, row in df.iterrows():
    ...
    for frame_num in range(start_frame, end_frame + 1):
        # 假设帧图像的文件名是纯数字，如 "110"
        frame_filename = f"00_{frame_num}.jpg"  # 假设文件扩展名是.jpg
